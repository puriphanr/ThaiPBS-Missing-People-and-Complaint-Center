...
<div class="container">
	<div class="col-lg-12">
		<ol class="breadcrumb">
			  ...
			  <li class="active">ปรึกษากฎหมาย</li>
		</ol>
	</div>
	<div class="col-lg-12">
		...
		<form id="target-form" class="form-horizontal" role="form" action="<?php echo home_url('process?fn=save_data')?>" method="POST" enctype="multipart/form-data">
			<div class="form-content">
				<input type="hidden" name="p_type" value="legal" />
...
$(function() {
			...
			$.ajax({
				...
				success : function(result){
					...
					if(result.status == true){
						window.location = '<?php echo home_url('legal')?>?complete='+result.id;
					}
					else{
	...
	$('#target-form').submit(function(e){
		...
		<div class="print-content" id="masterContent">
			<div class="form-head">
				<div class="form-title">ปรึกษากฎหมาย</div>
				<div class="row">
					<div class="col-lg-6">
